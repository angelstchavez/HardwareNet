...
{
    public partial class FormularioCategoriaProducto : Form
    {
        ...
        #region Eventos
        private void FormularioCategoriaProducto_Load(object sender, EventArgs e)
        {
        ...
        {
            ExportarExcel(tablaDatos, "Categorías de productos");
        }
