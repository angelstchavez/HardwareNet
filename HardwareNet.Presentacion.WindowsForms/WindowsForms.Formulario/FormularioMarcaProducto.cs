...
{
    public partial class FormularioMarcaProducto : Form
    {
        public FormularioMarcaProducto()
        {
            InitializeComponent();
        }
        ...
        {
            tablaDatos.DataSource = TestRegistrosLocales();
            contador.Text = TestRegistrosLocales().Count.ToString();
        }
        ...
        private void btnReporte_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No hay registros de marcas disponibles para generar un reporte.\nPor favor, agregue al menos un registro.",
                    "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            else
            {
                ReporteMarcaProducto formReporteMarca = new ReporteMarcaProducto();
                formReporteMarca.ShowDialog();
            }
        }
        ...
        {
            ExportarExcel(tablaDatos, "Marcas");
        }
        ...
        public static List<MarcaProducto> TestRegistrosLocales()
        {
            // Creamos un ArrayList para almacenar las marcas
            List<MarcaProducto> marcas = new List<MarcaProducto>
            {
                // Creamos y agregamos algunas marcas al ArrayList
                new MarcaProducto { IdMarcaProducto = 1, Nombre = "Apple", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 2, Nombre = "Samsung", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 3, Nombre = "Microsoft", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 4, Nombre = "Google", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 5, Nombre = "Sony", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 6, Nombre = "LG", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 7, Nombre = "HP", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 8, Nombre = "Dell", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 9, Nombre = "Lenovo", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 10, Nombre = "Asus", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 11, Nombre = "Acer", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 12, Nombre = "Intel", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 13, Nombre = "AMD", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 14, Nombre = "Nvidia", FechaCreacion = DateTime.Now },
                new MarcaProducto { IdMarcaProducto = 15, Nombre = "Corsair", FechaCreacion = DateTime.Now }
            };
            ...
            )
        {
            ...
            txtMarca.Enabled = habilitarTexto;
            txtMarca.Focus();
