...
{
    public partial class FormularioCategoriaProveedor : Form
    {
        public FormularioCategoriaProveedor()
        {
            InitializeComponent();
        }
        ...
        private void FormularioCategoriaProveedor_Load(object sender, EventArgs e)
        {
