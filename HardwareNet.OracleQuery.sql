...
-- Secuencias
CREATE SEQUENCE SQ_INCREMENTADOR_ROLES_USUARIO START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_MODULOS_ACCESO START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_TIPOS_DOCUMENTO START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_USUARIOS START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_CLIENTES START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_PROVEEDORES START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_CATEGORIAS_PRODUCTO START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_MARCAS START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_PRODUCTOS START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_FACTURAS_MAESTRAS START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_DETALLES_FACTURA START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_SUMINISTROS_MAESTROS START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE SQ_INCREMENTADOR_DETALLES_SUMINISTRO START WITH 1 INCREMENT BY 1;